...
module AsyncQueueSink_UInt145(
  input          clock,
  input          reset,
  input          io_deq_ready,
  output         io_deq_valid,
  output [144:0] io_deq_bits,
  input  [144:0] io_async_mem_0,
  input  [144:0] io_async_mem_1,
  input  [144:0] io_async_mem_2,
  input  [144:0] io_async_mem_3,
  input  [144:0] io_async_mem_4,
  input  [144:0] io_async_mem_5,
  input  [144:0] io_async_mem_6,
  input  [144:0] io_async_mem_7,
  ...
  ClockCrossingReg_w145 io_deq_bits_deq_bits_reg (
    .clock (clock),
