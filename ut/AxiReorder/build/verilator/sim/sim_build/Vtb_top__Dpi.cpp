...
//    1. Call Vtb_top::{export_function} instead,
...
void simulation_disableTrace() {
    ...
    return Vtb_top::simulation_disableTrace();
}
#endif
...
void simulation_enableTrace() {
    ...
    return Vtb_top::simulation_enableTrace();
}
#endif
...
void simulation_initializeTrace(const char* traceFilePath) {
    ...
    return Vtb_top::simulation_initializeTrace(traceFilePath);
}
#endif
