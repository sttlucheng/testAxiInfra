...
module AsyncQueueSource_UInt145(
  input          clock,
  input          reset,
  output         io_enq_ready,
  input          io_enq_valid,
  input  [144:0] io_enq_bits,
  output [144:0] io_async_mem_0,
  output [144:0] io_async_mem_1,
  output [144:0] io_async_mem_2,
  output [144:0] io_async_mem_3,
  output [144:0] io_async_mem_4,
  output [144:0] io_async_mem_5,
  output [144:0] io_async_mem_6,
  output [144:0] io_async_mem_7,
