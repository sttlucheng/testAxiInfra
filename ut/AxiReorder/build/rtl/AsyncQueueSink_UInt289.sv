...
module AsyncQueueSink_UInt289(
  input          clock,
  input          reset,
  input          io_deq_ready,
  output         io_deq_valid,
  output [288:0] io_deq_bits,
  input  [288:0] io_async_mem_0,
  input  [288:0] io_async_mem_1,
  input  [288:0] io_async_mem_2,
  input  [288:0] io_async_mem_3,
  input  [288:0] io_async_mem_4,
  input  [288:0] io_async_mem_5,
  input  [288:0] io_async_mem_6,
  input  [288:0] io_async_mem_7,
  ...
  ClockCrossingReg_w289 io_deq_bits_deq_bits_reg (
    .clock (clock),
