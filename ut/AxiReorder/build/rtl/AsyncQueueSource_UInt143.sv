...
module AsyncQueueSource_UInt143(
  input          clock,
  input          reset,
  output         io_enq_ready,
  input          io_enq_valid,
  input  [142:0] io_enq_bits,
  output [142:0] io_async_mem_0,
  output [142:0] io_async_mem_1,
  output [142:0] io_async_mem_2,
  output [142:0] io_async_mem_3,
  output [142:0] io_async_mem_4,
  output [142:0] io_async_mem_5,
  output [142:0] io_async_mem_6,
  output [142:0] io_async_mem_7,
