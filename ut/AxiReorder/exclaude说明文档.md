...
# condition
  ...
  #### wire aw_mst_fire_hit_0 = wq_io_enq_valid & _awsel_T_1[0] & _awsel_res_bits_T_1[0]; 
    ...
    由于_awsel_T_1 = ~_awsel_res_bits_T且_awsel_res_bits_T = wvld，_awsel_res_bits_T_1 = wvld + 64'h1，所以_awsel_T_1[0] = ~wvld[0]、_awsel_res_bits_T_1[0]= wvld[0] + 1 = ~wvld[0],因此该condition中_awsel_T_1[0]和_awsel_res_bits_T_1[0]必须相同，需要exclaude不同的condition。
